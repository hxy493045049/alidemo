...
public class AliyunListPlayerView extends FrameLayout {
            ...
            public void onRenderingStart() {
                if (mListPlayerRecyclerView != null) {
                    AliyunRecyclerViewAdapter.MyViewHolder mViewHolder =
                            (AliyunRecyclerViewAdapter.MyViewHolder) mListPlayerRecyclerView.findViewHolderForLayoutPosition(mCurrentPosition);
                    if (mViewHolder != null) {
    ...
    private void initRecyclerView() {
        View mListPlayerRecyclerViewRoot =
                LayoutInflater.from(getContext()).inflate(R.layout.layout_list_player_recyclerview, this, true);
            ...
            mPagerLayoutManager.setOnViewPagerListener(new OnViewPagerListener() {
                ...
                public void onPageRelease(boolean isNext, int position, View view) {
                    if (mCurrentPosition == position) {
                        ...
                        stopPlay();
                        AliyunRecyclerViewAdapter.MyViewHolder holder =
                                (AliyunRecyclerViewAdapter.MyViewHolder) mListPlayerRecyclerView.findViewHolderForLayoutPosition(position);
                        if (holder != null) {
    ...
    public void addVid(String videoId, String randomUUID) {
        if (mAliListPlayer != null) {
            ...
            try {
                File f = new File(getContext().getCacheDir(), "temp.mp4");

                FileOutputStream outputStream = new FileOutputStream(f);

                InputStream inputStream = assetManager.open("test.mp4");
                int read;
                ...
                mAliListPlayer.addUrl(f.getAbsolutePath(), randomUUID);
            } catch (IOException e) {
                e.printStackTrace();
            }

//            mAliListPlayer.addUrl("http://alimov2.a.yximgs" +
//                    ".com/upic/2020/08/09/14" +
//                    "/BMjAyMDA4MDkxNDA2NTFfMTc0Mjg1MThfMzM5OTYxOTEzNjJfMV8z_b_Ba27329a14a5ae533df1e50ff462ceb2f" +
//                    ".mp4?tag=1-1597263392-p-0-5967be10b83044ab-3d4b358efb604372&type=hot&tt=b&di=702c6ada&bp=10011",
//                    randomUUID);
